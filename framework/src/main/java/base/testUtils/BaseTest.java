...
public class BaseTest {
    ...
    @BeforeClass
    public void setUp(@Optional String browser, @Optional String module) throws MalformedURLException {
    //public void setUp() throws MalformedURLException {
        ...
        DriverFactory.launchApp(browser, module);
