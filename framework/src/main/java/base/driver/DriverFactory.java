...
public class DriverFactory {
    ...
    public static void launchApp(String browser, String module) throws MalformedURLException {
        ...
        String targetUrl = JsonReader.getUrlByModule(module);
